...
$gemspec = Gem::Specification.new do |s|
  ...
  s.homepage          = 'http://github.com/deepfryed/fuzzy'
  s.files             = Dir['ext/**/*.{c,h}'] + Dir['{ext,test,lib}/**/*.rb'] + %w(README.md CHANGELOG)
  s.extensions        = %w(ext/fuzzy/extconf.rb)
...
task :gemspec do 
  ...
  $gemspec.version = File.read($rootdir + 'ext/fuzzy/version.h').scan(/[\d.]+/).first
